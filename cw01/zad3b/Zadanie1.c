...
{ //wczytanie danych
	List* l = initList();
	AddPerson(l,1, "Nowak");
	AddPerson(l,1, "Kowalski");
	AddPerson(l,2, "Milkowski");

	List* sortedList = sortListByNumber(l, 4);
	printPerson(l,1,"Kowalski");
	Person* p = findPerson(l,2,"Kowalski");

    printPerson(l,2,"Kowalski");
	deletePerson(l,3,"Milkowski");

		deletePerson(l,1,"Nowak");
		deletePerson(l,3,"Milkowski");
